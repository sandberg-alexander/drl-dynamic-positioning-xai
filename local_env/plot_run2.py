...
ax1.plot(x_d, color='red', linestyle='--', linewidth=1.5*scale, label='Desired pose')
ax1.plot(dt[render_start:render_end],x_d-x[render_start:render_end], linewidth=1.5*scale, color='black', label="Real pose (simulator)")
...
ax2.plot(y_d, color='red', linestyle='--', linewidth=1.5*scale, label='Desired pose')
ax2.plot(dt[render_start:render_end],y_d-y[render_start:render_end], linewidth=1.5*scale, color='black', label="Real pose (simulator)")
...
ax3.plot(psi_d, color='red', linestyle='--', linewidth=1.5*scale, label='Desired pose')
ax3.plot(dt[render_start:render_end],psi_d-psi[render_start:render_end], linewidth=1.5*scale, color='black', label="Real pose (simulator)")
...
plt.tight_layout()
plt.savefig(f'plots/drl/runs/{run_number}_states.pdf', format='pdf', dpi=1200)
plt.close(fig)

# States2
fig, (ax1,ax2,ax3) = plt.subplots(3,1,figsize=(10,4.8*2))

ax1.axhline(y=0, color='gray', linestyle='--', linewidth=1.5*scale,label=f"(y={0})")
ax1.plot(dt[render_start:render_end],u[render_start:render_end], linewidth=1.5*scale, color='black')
ax1.legend(fontsize=10*scale)
ax1.set_xlabel(r'time step [dt]', fontsize=14*scale)
...
ax2.plot(dt[render_start:render_end],v[render_start:render_end], linewidth=1.5*scale, color='black')
ax2.legend(fontsize=10*scale)
ax2.set_xlabel(r'time step [dt]', fontsize=14*scale)
...
ax3.plot(dt[render_start:render_end],r[render_start:render_end], linewidth=1.5*scale, color='black')
ax3.legend(fontsize=10*scale)
ax3.set_xlabel(r'time step [dt]', fontsize=14*scale)
...
plt.tight_layout()
plt.savefig(f'plots/drl/runs/{run_number}_states2.pdf', format='pdf', dpi=1200)
plt.close(fig)
