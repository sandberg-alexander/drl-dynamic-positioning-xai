...
monitor_data = pd.read_csv('../data/models/training_20250404_165037/logs/monitor.csv',skiprows=1)  # Skip the first row (header)
...
plt.tight_layout()
plt.savefig('plots/drl/episode_reward/episode_plot_3_r.pdf', format='pdf', dpi=1200)
plt.close(fig)
...
plt.tight_layout()
plt.savefig('plots/drl/episode_reward/episode_plot_3_r2.pdf', format='pdf', dpi=1200)
plt.close(fig)
...
plt.tight_layout()
plt.savefig('plots/drl/episode_reward/episode_plot_3_l.pdf', format='pdf', dpi=1200)
plt.close(fig)