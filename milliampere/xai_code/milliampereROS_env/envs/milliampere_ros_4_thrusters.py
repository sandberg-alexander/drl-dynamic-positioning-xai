...
class MilliampereRosEnv4Thrusters(gym.Env):
    ...
    def render(self):
        ...
        if z_value >= 0:
            ...
            center_color = (255 - intensity, 255, 255 - intensity)  # Transition from white to dark green
        else:
            intensity = int((abs(z_value) / abs(self.max_reward)) * 255)
            center_color = (255, 255 - intensity, 255 - intensity)  # Transition from white to dark red
